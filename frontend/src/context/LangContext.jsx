...
const translations = {
  en: {
    categories: {
      ...
      Beach: 'Beach', Park: 'Park', Attraction: 'Attraction', Transportation: 'Taxi', Other: 'Other', Closed: 'Closed',
      Events: 'Events',
    },
    events: 'Events',
    ...
    owner: {
      ...
      nameEsPlaceholder: 'Optional Spanish name…',
      descLabel: 'Description (English)',
      descEsLabel: 'Description (Spanish)',
      descEsPlaceholder: 'Optional Spanish description…',
  ...
  es: {
    categories: {
      ...
      Beach: 'Playa', Park: 'Parque', Attraction: 'Atracción', Transportation: 'Taxi', Other: 'Otro', Closed: 'Cerrado',
      Events: 'Eventos',
    },
    events: 'Eventos',
    ...
    owner: {
      ...
      nameEsPlaceholder: 'Nombre en español (opcional)…',
      descLabel: 'Descripción (inglés)',
      descEsLabel: 'Descripción (español)',
      descEsPlaceholder: 'Descripción en español (opcional)…',
